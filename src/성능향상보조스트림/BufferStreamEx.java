...
// 프로그램과 입출력장치 사이에는 엄청난 속도차이가 발생하며, 이로 인해서 병목현상이 발생합니다.
// 이를 해결하기 위해서 성능 향상 보조 스트림을 사용합니다.
public class BufferStreamEx {
    public static void main(String[] args) throws IOException {
        FileInputStream fis = null;
        FileOutputStream fos = null;
        BufferedInputStream bis = null; // 성능향상보조스트림
        BufferedOutputStream bos = null;
        int data = -1; // 파일의 끝을 확인하기 위한 변수
        long start = 0; // 시작 시간
        long end = 0; // 종료 시간

//        fis = new FileInputStream("src/성능향상보조스트림/chicken.jpg");
//        bis = new BufferedInputStream(fis);
//        fos = new FileOutputStream("d:/tmp/치킨2번.jpg");
